...
describe('監査: 計算エンジンの自己疑義・数学的立証', () => {
    ...
    it('監査1: 45度テーパー接続時の退避量 (手計算 Docs 第1節)', () => {
        ...
        // 幾何学的交点法（修正版 tan(θ/2)）による計算:
        // 垂直→45°テーパー接続点
        // n1 = (1,0), n2 = (0.707, 0.707), dot = 0.707
        // angle = 45°, halfAngle = 22.5°, tan(22.5°) = 0.414
        // dist = R×tan(22.5°) = 0.331
        // 接合ノードZ = 0 + (0.383)*0.331 = 0.127
        // プログラムZ = 0.127 - 0.8 = -0.673
        console.log(`監査1 (45度カド Z位置) 実測値: ${comp.startZ}`)
        expect(comp.startZ).toBeCloseTo(-0.673, 2)
    })
